						...
						<table class="table table-condensed table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="">Tenant</th>
									<th class="">Date Of Entry</th>
									<th class="">Date Off Property</th>
									<th class="">House Info</th>
									<th class="">Status</th>
							...
							<tbody>
								...
								$movements = $conn->query("SELECT floors,name,transmission_id,engine_id inner join books ");
								...
								<tr>
									...
									<td>
									<p>Building Name: <b><?php echo ucwords($row['model']) ?></b></p>
										 <p>Floors <b><?php echo ucwords($row['brand']) ?></b></p>
